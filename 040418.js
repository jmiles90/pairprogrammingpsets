...
// 1. Write a function that returns its argument converted to a string.

function returnString(argument) {
  //ENTER YOUR CODE HERE
}

// console.log(JSON.stringify(returnString(1234)) === JSON.stringify('1234'));
// console.log(JSON.stringify(returnString(true)) === JSON.stringify('true'));
// console.log(JSON.stringify(returnString(0)) === JSON.stringify('0'));
///
